...
import { PlatformHeroAnimation } from '@/components/animations/PlatformHeroAnimation';
      ...
      <div className="container-width section-padding relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[600px] py-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Hét platform om alles over{' '}
                <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  AI te leren
                </span>
              </h1>
              <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
                Word expert in GenAI en LLMs. Van ChatGPT basics tot geavanceerde 
                AI-toepassingen. Leer van Nederlandse experts en ontvang erkende certificaten.
              </p>
            </div>
          ...
          <div className="relative">
            {/* AI Animation */}
            <div className="relative bg-gradient-to-br from-gray-100 to-white rounded-2xl p-1 shadow-2xl">
              <div className="aspect-video bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
                <PlatformHeroAnimation />
              </div>
            </div>
